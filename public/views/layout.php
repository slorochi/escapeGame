        ...
        <div class="row">
            <div class="col-md-12" id="hautmenu">
                <div class="row">
                    ...
                    <!-- Si connecter on utilise -->
                    <div class="col-6 login">
                        <div class="niveau"><span>Niveau&nbsp5</span></div>
                        <a href="#" class="connection">
                            <img src="views/style/img/avatar5.png" alt="">
                            <span class="user">Compte de Bob</span>
                        </a>
                        <a href="?p=logout" class="deconnexion"><i class="fa-solid fa-right-from-bracket"></i>Déconnexion</a>
                    </div>

                    <!-- Si deconnecter on utilise -->
                    <!-- <div class="col-3 login">
                        <a href="?p=logout" class="deconnexion"><i class="fa-solid fa-arrow-right-to-bracket"></i>Connexion</a>
                    </div> -->
                </div>
            </div>
