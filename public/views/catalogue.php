...
<header>
    <div class="container header">
        <div class="row">
            <div class="col-md-12" id="hautmenu">
                <div class="row">
                    ...
                    <div class="col-md-3 login">
                        <div class="niveau"><span>lvl 5</span></div>
            ...
            <div class="col-md-12" id="basmenu">
                <div class="row">
                    <a href="?p=accueil"class="col-md-3" >Accueil</a>
                    <a href="?p=leaderboard"class="col-md-3" >Leader Board</a>
                    <a href="?p=catalogue"class="col-md-3" >Catalogue</a>
                    <a href="?p=contact"class="col-md-3" >Contact</a>
                </div>
            </div>
        </div>
    </div>
...
<section id="Catalogue">
    <div class="container">
        <div class="row">
            ...
            <div class="card col-md-6">
                <img class="card-img-top" src="views/style/img/Escape-game-peur-mtp_0.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
            ...
            <div class="card col-md-6">
                <img class="card-img-top" src="views/style/img/Secteur7.png" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
            ...
            <div class="card col-md-6">
                <img class="card-img-top" src="views/style/img/un-crime-presque-parfait-escape-game-lock-academy.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
